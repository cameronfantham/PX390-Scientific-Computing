...
/* Initialise a band matrix of a certain size,
   allocate memory, and set the parameters                  */
...
/* Solve the equation Ax = b for a matrix a stored in
   band format and x and b real arrays.                     */
...
/* Reindex for periodicity in band matrix, m(i) */
